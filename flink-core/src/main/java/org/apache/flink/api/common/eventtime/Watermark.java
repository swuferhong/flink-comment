...
public final class Watermark implements Serializable {
	...
	/*TODO WaterMark用法
	*  TODO 与业务时间保持一致的定义：Watermark（业务时间戳）
	*   TODO 允许业务乱序程度不超过1分钟的定义 Watermark(业务时间戳 - 60000)
	*   */
	...
	/*TODO watermark触发窗口的计算，那么Long.MAX_VALUE值会公诉算在后续没有任何数据了*/
	public static final Watermark MAX_WATERMARK = new Watermark(Long.MAX_VALUE);

	// ------------------------------------------------------------------------

	/** The timestamp of the watermark in milliseconds. */
	/*TODO WaterMark表示一个时间戳，他表示小于这个时间戳的时间都已经到达了*/
	/*TODO WaterMark本身是一个时间戳 */
