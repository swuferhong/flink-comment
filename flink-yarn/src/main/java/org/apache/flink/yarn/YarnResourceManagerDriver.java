...
public class YarnResourceManagerDriver extends AbstractResourceManagerDriver<YarnWorkerNode> {
	...
	protected void initializeInternal() throws Exception {
		...
		try {
			/*TODO 在ApplicationMaster的Flink的ResourceManager中创建yarn的ResourceManager客户端来控制调度，并且初始化和启动*/
		...
		/*TODO 创建yarn的 NodeManager的客户端， 并且初始化和启动 ==》注意这些部分都是在yarn创建的AppMaster中 创建的 RESOURCEmanager中的*/
