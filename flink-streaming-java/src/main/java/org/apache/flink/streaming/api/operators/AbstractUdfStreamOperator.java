...
public abstract class AbstractUdfStreamOperator<OUT, F extends Function>
	...
	public void snapshotState(StateSnapshotContext context) throws Exception {
		...
		/*TODO 判断userFunction是否属于CheckpointedFunction或者ListCheckpointed的实例*/
		/*TODO 吐过是则调用用户实现的snapshotState执行相关逻辑*/
		/*TODO 比如FlinkKafkaConsumerBase则自己实现了CheckpointedFunction的接口*/
