...
public class ExecutionGraph implements AccessExecutionGraph {
	...
	public void enableCheckpointing(
		...
		/*TODO  核心方法是创建CheckpointCoordinator对象*/
		...
		if (chkConfig.getCheckpointInterval() != Long.MAX_VALUE) {
			...
			/*TODO 在这里会注册一个作业状态的监听CheckpointCoordinatorDeActivator， 该监视器会在作业状态发生改变时得到通知*/
	...
	public void attachJobGraph(List<JobVertex> topologiallySorted) throws JobException {
		...
		for (JobVertex jobVertex : topologiallySorted) {
			/*TODO 对于所有在拓扑图中的JobVertex，做如下操作*/
			...
			/*TODO 实例化执行图节点，根据每一个job vertex， 创建对应的 ExecutionJobVertex*/
			...
			/*TODO 将创建的ExecutionJobVertex与前置的IntermediateResult连接起来*/
			/*TODO 核心步骤： 如何连接*/
			...
			// 节点总数量需要加上当前执行图节点的并行度，因为执行图是作业图的并行化版本
