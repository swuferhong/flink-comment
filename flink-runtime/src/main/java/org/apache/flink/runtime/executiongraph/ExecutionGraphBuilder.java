...
public class ExecutionGraphBuilder {
	...
	/*TODO 这里就是真正的ExecutionGraph的执行逻辑的封装*/
	public static ExecutionGraph buildGraph(
		@Nullable ExecutionGraph prior,
		JobGraph jobGraph,
		Configuration jobManagerConfig,
		...
		/*TODO 核心逻辑： 将拓扑排序过后的JobGraph添加到executionGraph数据结构中；*/
		/*TODO 创建executionGraph的核心逻辑就在这里*/
		...
		if (snapshotSettings != null) {
			...
			/*TODO 如果我们开启了CheckPoint机制，就会调用ExecutionGraph的enableCheckpointing()方法*/
