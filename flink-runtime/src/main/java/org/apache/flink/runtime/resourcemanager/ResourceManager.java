...
public abstract class ResourceManager<WorkerType extends ResourceIDRetrievable>
	...
	public final void onStart() throws Exception {
		try {
			/*TODO ResourceManager 对象实现 start() 方法就会启动相应的Rpc方法，然后就要来ResourceManager里面找Onstart() 方法*/
	...
	private void startResourceManagerServices() throws Exception {
		try {
			...
			/*TODO 创建了yarn的RM 和 NM 的 客户端， 初始化并启动*/
			initialize(); // 初始化

			/*TODO 这里又开始选leader，然后start()。 通过选举服务，启动ResourceManager*/
	...
	public CompletableFuture<Acknowledge> sendSlotReport(ResourceID taskManagerResourceId, InstanceID taskManagerRegistrationId, SlotReport slotReport, Time timeout) {
		...
		if (workerTypeWorkerRegistration.getInstanceID().equals(taskManagerRegistrationId)) {
			/*TODO TaskExecutor最终是注册给 slotManager*/
	...
	public CompletableFuture<Acknowledge> requestSlot(
		...
		if (null != jobManagerRegistration) {
			if (Objects.equals(jobMasterId, jobManagerRegistration.getJobMasterId())) {
				...
				try {
					/*TODO JobMaster里的slotPool来申请Slot，通过rpc调用找到Flink ResourceManager的slotManager来向yarn中的ResourceManager申请资源*/
	...
	private void startServicesOnLeadership() {
		/*TODO 启动心跳服务, 跟TaskManager和 JobMaster启动心跳*/
		startHeartbeatServices();

		/*TODO 启动slotManager， 所以Flink内部真正管理slot资源的是ResourceManager*/
		/*TODO 在源代码级别， 记得Flink里面的Slot的管理者是ResourceManager*/
